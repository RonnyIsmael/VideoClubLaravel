...
class CatalogController extends Controller
{
    ...
    {
        $lista = $this->arrayPeliculas;
        return view('catalog.index', array('arrayPeliculas'=>$lista));
    }
    public function getShow($id)
    {
        $peliculaDetalles = $this->arrayPeliculas[$id];
        $aux = $peliculaDetalles['rented'];
        if ($aux){
            $estado = "Alquilada";
            $botonEstado = " <a class='btn btn-danger' href='#'>Devolver Película</a>";
        }else{
            $estado = "Disponible";
            $botonEstado = ' <a class="btn btn-primary" href="#">Alquilar Película</a>';

        }
        return view('catalog.show', array('detalles'=>$peliculaDetalles))->with('estado',$estado)->with('botonEstado',$botonEstado)->with('id',$id);
    }
